...
export const storyEvidenceContract = {
  ...
  novelEditionId: 'hero-wuming-v1-5',
  novelPdfSha256: 'dd484437dbd0d80e8fa19f1bd430ef00f3ac67fac909f5cbe3a1c416f415b9f5',
  novelDocxSha256: 'e81628d270dd59c7d1742f46b08922e39b7df194963f5b7682af43557128afe8',
...
export const evidencePaths: readonly EvidencePath[] = [
  {
    ...
    storyPageStart: 15,
    storyPageEnd: 23,
    chapterAssetSha256: '3c04909edd3896f78590676e2091d179c6398e463f78074f595a51ef1b8a13e7',
  ...
  },
  {
    ...
    period: '1942-08',
    mode: 'research_note',
    storyLabel: '《英雄无名》第十九章 · 延安',
    storyHref: '/novel/chapter/chapter-19',
    storyQuestion: '敌方情报表里的一行列名，能否成为秘密行动的证据？',
    chapterSlug: 'chapter-19',
    storyPageStart: 249,
    storyPageEnd: 268,
    chapterAssetSha256: '246880ab36cb6720b27d0486a5234f228c1653c4ddde40a482627376a3158d40',
  ...
  },
  {
    ...
    period: '1948—1949',
    mode: 'blocked',
    storyLabel: '《英雄无名》第二十六章 · 围城',
    storyHref: '/novel/chapter/chapter-26',
    storyQuestion: '戏剧上最有力的一刻，为什么在史料链里必须显示空白？',
    chapterSlug: 'chapter-26',
    storyPageStart: 337,
    storyPageEnd: 348,
    chapterAssetSha256: '9898d9c6e3a29198a2891e360fa1a5b9ab401b8c4cd142c90c82eb0ad543faa4',
    claimIds: [],
    sourceIds: [],
    selectedSourceIds: [],
    sourceFamilyCount: 0,
  ...
  },
  {
    ...
    period: '1949—1950',
    mode: 'blocked',
    storyLabel: '《英雄无名》第三十章 · 破案不能认领',
    storyHref: '/novel/chapter/chapter-30',
    storyQuestion: '真实案件背景与真实人物参与之间，缺的究竟是哪一环？',
    chapterSlug: 'chapter-30',
    storyPageStart: 383,
    storyPageEnd: 400,
    chapterAssetSha256: '005b4ab6ab5db091fb66adfe5a0d8d25eea9d44615c7562af914a65cd9caab67',
    claimIds: [],
    sourceIds: [],
    selectedSourceIds: [],
    sourceFamilyCount: 0,
