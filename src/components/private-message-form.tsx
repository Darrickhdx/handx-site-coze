    ...
    >
      ...
      <label className="mt-5 grid gap-2 text-xs text-[#c8c4bc]">
        ...
        <textarea
          ...
          className="resize-y border border-white/20 bg-[#17201f] px-3 py-3 text-sm leading-[1.7] text-white outline-none transition placeholder:text-white/30 focus:border-[#d5a09a]"
        />
      </label>
