...
export function IdentityDossier() {
  ...
  return (
    <div id="dossier-start" className="scroll-mt-28">
        ...
        <div className="personal-shell grid gap-8 xl:grid-cols-[minmax(0,1.05fr)_minmax(25rem,0.95fr)] xl:gap-14">
          <div className="relative min-h-[32rem] overflow-hidden border border-foreground/15 bg-[#e9e3d8] p-5 shadow-[0_24px_70px_rgba(31,35,33,0.12)] sm:p-8">
            ...
            {active.image ? (
              ...
              <div className="mt-7 flex min-h-64 items-center justify-center border border-foreground/15 bg-[linear-gradient(rgba(255,255,255,.55),rgba(255,255,255,.55)),repeating-linear-gradient(0deg,transparent,transparent_31px,rgba(74,69,58,.11)_32px)] px-6 py-7 text-center sm:px-12">
                <div>
          ...
          <div aria-live="polite" aria-atomic="true">
            ...
            <div className="mt-8 grid gap-5 sm:grid-cols-2">
              <div className="border-t-2 border-emerald-800/45 pt-5">
                ...
                <ul className="mt-4 space-y-3 text-sm leading-[1.7] text-muted-foreground">
            ...
            <div className="mt-8 border border-foreground/15 bg-card p-5 sm:p-6">
              ...
              <p className="mt-5 flex gap-3 border-t border-foreground/15 pt-5 text-sm leading-[1.7] text-muted-foreground">
      ...
      <section className="border-y border-foreground/15 bg-[#eee9df] py-7 sm:py-10">
        <div className="personal-shell">
          ...
          {trackMode === 'separate' ? (
            ...
            <div className="mt-7 border border-dashed border-primary/45 bg-background p-6 sm:p-8">
              <div className="max-w-3xl">
                ...
                <ol className="mt-7 space-y-0">
                  {identityTrackComparison.assumedBridge.map((record) => (
                    <li key={record} className="relative border-l border-primary/35 pb-7 pl-7 text-sm leading-[1.7] text-foreground last:pb-0">
                      <span className="absolute -left-1.5 top-2 size-3 rounded-full border-2 border-background bg-primary" aria-hidden="true" />
                      {record}
                    </li>
                  ))}
              ...
              <p className="mt-8 border-l-2 border-amber-700 bg-amber-50 px-5 py-4 text-sm leading-[1.7] text-amber-950">
      ...
      <section id="dossier-verdict" className="scroll-mt-28 border-y border-white/15 bg-[#202827] py-14 text-[#f3efe7] sm:py-10">
        <div className="personal-shell grid gap-12 lg:grid-cols-[0.72fr_1.28fr] lg:gap-14">
          <div>
            ...
            <div className="mt-7 border border-white/15 p-5">
              ...
              <p className="mt-3 text-sm leading-[1.7] text-[#d7cfc2]">{summarizeJudgments(judgments)}</p>
            ...
            <div>
              ...
              <ul className="mt-5 space-y-4">
                {identityDossierVerdict.established.map((item) => (
                  <li key={item} className="flex gap-3 border-t border-white/15 pt-4 text-sm leading-[1.7] text-[#d7cfc2]">
