    ...
    <main>
      <header className="border-b border-foreground/15">
        <div className="article-shell py-12 sm:py-20">
          ...
          <h1 className="mt-5 font-serif text-[clamp(3.2rem,7vw,6.4rem)] font-semibold leading-[0.96] tracking-[-0.055em]">
        ...
        <section className="mt-16 grid gap-8 lg:grid-cols-[1fr_0.8fr]">
          <div>
            ...
            {directSuEdges.length > 0 ? (
              ...
              <div className="mt-6 border border-foreground/15 bg-card p-5 text-sm leading-7 text-muted-foreground">
