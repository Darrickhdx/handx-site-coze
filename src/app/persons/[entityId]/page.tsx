  ...
  return (
    <div className="min-h-screen bg-[#f4f0e8]" data-person-dossier={entityId}>
        ...
        <div className="personal-shell py-12 sm:py-20">
          ...
          <div className="mt-12 grid gap-10 lg:grid-cols-[12rem_minmax(0,1fr)] lg:items-end lg:gap-16">
            ...
            <div>
              ...
              <p className="mt-7 max-w-4xl font-serif text-2xl leading-relaxed text-[#d7cfc2] sm:text-3xl">{dossier.oneLine}</p>
            </div>
          </div>
        </div>
      </header>
      ...
      <div className="personal-shell py-12 sm:py-20">
        ...
        <section className="grid gap-8 border-y border-foreground/15 py-12 lg:grid-cols-[1fr_0.8fr]">
          <div>
