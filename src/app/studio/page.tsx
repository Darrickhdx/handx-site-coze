  ...
  return (
    <div className="studio-page">
      <section className="border-b border-foreground/15">
        <div className="personal-shell grid gap-12 py-16 sm:py-24 lg:grid-cols-[minmax(0,0.9fr)_minmax(28rem,1.1fr)] lg:items-end lg:gap-20">
          <div>
            <p className="personal-kicker">
              <span aria-hidden="true" />
              Family history studio
            </p>
            <h1 className="personal-display mt-7 text-[clamp(3.4rem,6.8vw,6.6rem)] font-semibold leading-[0.94] tracking-[-0.06em]">
              家族史工作室
            </h1>
          </div>
          <div>
