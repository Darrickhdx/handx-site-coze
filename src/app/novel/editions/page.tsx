    ...
    <div className="min-h-screen bg-[#f4f0e8]">
      ...
      <header className="border-b border-white/15 bg-[#202827] text-[#f3efe7]">
        <div className="personal-shell py-9 sm:py-14">
          ...
          <div className="mt-9 grid gap-10 lg:grid-cols-[0.78fr_1.22fr] lg:items-end lg:gap-14">
            <div>
              <p className="personal-kicker personal-kicker-light"><span aria-hidden="true" />Edition control</p>
              <h1 className="mt-7 font-serif text-[clamp(1.87rem,3.64vw,3.64rem)] font-semibold leading-[0.9] tracking-[-0.065em]">
                换一本书，
                <br />
                不是换一个文件。
              </h1>
