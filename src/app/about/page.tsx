  ...
  return (
    <div className="profile-page overflow-hidden">
      <section className="profile-hero border-b border-foreground/15">
        <div className="personal-shell grid gap-12 py-12 sm:py-14 lg:min-h-[calc(100svh-7.5rem)] lg:grid-cols-[minmax(0,0.92fr)_minmax(25rem,0.78fr)] lg:items-start lg:gap-16">
          <div>
            ...
            <h1 className="personal-display mt-4 text-[clamp(3.6rem,6vw,6.3rem)] font-semibold leading-[0.92] tracking-[-0.065em]">
              {profile.displayName}
            </h1>
