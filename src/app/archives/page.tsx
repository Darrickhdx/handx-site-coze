  ...
  return (
    <div>
      ...
      <header className="border-b border-foreground/15 bg-[#eee9df]">
        <div className="story-shell grid gap-10 py-16 sm:py-7 lg:grid-cols-[minmax(0,1.1fr)_minmax(18rem,0.65fr)] lg:items-end">
          <div>
            <p className="personal-kicker"><span aria-hidden="true" />Archive, read like a story</p>
            <h1 className="mt-7 max-w-4xl font-serif text-[clamp(1.34rem,2.84vw,2.60rem)] font-semibold leading-[0.94] tracking-[-0.06em]">
              先别查编号。<br />先回到那一页纸、那座城、那一天。
            </h1>
            <p className="mt-8 max-w-2xl text-[15px] leading-[1.7] text-muted-foreground sm:text-lg">
      ...
      <main className="story-shell py-16 sm:py-10">
        ...
        <details className="mt-16 border-t border-foreground/15 pt-7 sm:mt-24">
          <summary className="cursor-pointer list-none text-left">
            ...
            <span className="mt-3 block max-w-2xl text-sm leading-[1.7] text-muted-foreground">
