  ...
  return (
    <div className="story-home overflow-hidden">
      ...
      <section className="sukaiyuan-hero border-b border-white/10 text-[#f3efe7]">
        <div className="story-shell grid min-h-[17rem] gap-12 py-8 lg:grid-cols-[minmax(0,0.88fr)_minmax(31rem,1.12fr)] lg:items-start lg:gap-14 lg:py-10">
      ...
      <section id="pingdiquan" className="scroll-mt-32 border-b border-foreground/15 py-8 sm:py-8">
      ...
      <section className="border-b border-foreground/15 bg-[#eee9df] py-16 sm:py-10">
      ...
      <section id="archive" className="scroll-mt-32 py-8 sm:py-8">
        <div className="story-shell">
          <div className="grid gap-8 border-b border-foreground/15 pb-9 lg:grid-cols-[0.72fr_1.28fr] lg:items-end lg:gap-14">
            <div>
              <p className="personal-kicker">
      ...
      <section className="border-y border-foreground/15 bg-[#eee9df] py-8 sm:py-8">
