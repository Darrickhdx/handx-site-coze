  ...
  return (
    <div className="min-w-0 overflow-hidden bg-background">
      ...
      <header className="border-b border-foreground/15">
        <div className="personal-shell min-w-0 py-9 sm:py-10">
      ...
      <main>
            ...
            <div className="grid gap-10 lg:grid-cols-[0.62fr_1.38fr] lg:gap-14">
              ...
              <div className="space-y-4">
                {mission.targets.length > 1 && (
                  <p className="border border-[#c38a82]/35 bg-[#c38a82]/10 p-4 text-sm leading-[1.7] text-[#d7cfc2]">
              ...
              <div className="space-y-4">
                {journal.length > 0 ? journal.map((entry, index) => (
                  <article key={`${entry.action}-${index}`} className="border border-foreground/15 bg-card p-6 sm:p-7">
                    ...
                    <p className="mt-6 border-l-2 border-primary pl-4 text-sm leading-[1.7] text-muted-foreground">
        ...
        <section id="public-locator-builder" className="scroll-mt-28 py-16 sm:py-10">
          <div className="personal-shell min-w-0">
