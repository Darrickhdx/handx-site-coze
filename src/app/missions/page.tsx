  ...
  return (
    <div className="min-w-0 overflow-hidden bg-background">
      ...
      <section className="border-b border-foreground/15">
        <div className="personal-shell grid min-w-0 gap-12 py-16 sm:py-24 lg:grid-cols-[minmax(0,1.2fr)_minmax(19rem,0.55fr)] lg:items-end lg:gap-20">
          <div className="min-w-0">
            <p className="personal-kicker"><span aria-hidden="true" />寻找苏开元 · 查档现场</p>
            <h1 className="personal-display mt-7 max-w-5xl text-[clamp(3.2rem,6vw,6.3rem)] font-semibold leading-[0.96] tracking-[-0.06em]">
              一份原件，
      ...
      <section id="first-batch" className="scroll-mt-28 border-b border-foreground/15 py-16 sm:py-24">
        <div className="personal-shell min-w-0">
          <div className="grid gap-7 border-b border-foreground/15 pb-8 lg:grid-cols-[0.72fr_1.28fr] lg:items-end lg:gap-20">
            <div>
          ...
          <div className="grid min-w-0 gap-px overflow-hidden border-x border-b border-foreground/15 bg-foreground/15 lg:grid-cols-2">
            {highlighted.map((mission, index) => (
              <article key={mission.missionId} className="flex min-w-0 flex-col bg-background p-6 sm:p-8">
                ...
                <h3 className="mt-7 break-words font-serif text-2xl font-semibold leading-snug tracking-[-0.025em] sm:text-3xl">
                  {mission.researchQuestion}
                </h3>
                <p className="mt-5 flex min-w-0 items-start gap-2 text-sm leading-7 text-muted-foreground">
                ...
                <div className="mt-6 border-t border-foreground/15 pt-5">
                  ...
                  <p className="mt-3 text-sm leading-7">{mission.completionStandard}</p>
                </div>
      ...
      <section id="all-missions" className="scroll-mt-28 py-16 sm:py-24">
        <div className="personal-shell min-w-0">
            ...
            <div className="space-y-5">
              {archiveMissionDataset.journal.map((entry, index) => (
                <article key={`${entry.action}-${index}`} className="border border-white/15 bg-white/[0.035] p-6 sm:p-8">
                  ...
                  <p className="mt-6 border-l-2 border-[#c38a82] pl-4 text-sm leading-7 text-[#d7cfc2]">
      ...
      <section className="py-16 sm:py-24">
        <div className="personal-shell grid min-w-0 gap-10 lg:grid-cols-[minmax(0,1.15fr)_minmax(18rem,0.65fr)] lg:items-end lg:gap-20">
          <div className="min-w-0">
            ...
            <div className="mt-7 flex items-start gap-3 border-l-2 border-primary bg-[#eee8dc] p-5 text-sm leading-7">
