    ...
    <main className="min-h-screen bg-[#f4f0e8]">
      <header className="border-b border-white/15 bg-[#202827] text-[#f3efe7]">
        <div className="article-shell py-12 sm:py-20">
          ...
          <h1 className="mt-5 font-serif text-[clamp(3rem,7vw,6.2rem)] font-semibold leading-[0.96] tracking-[-0.055em]">
            {node.label}
          </h1>
          <p className="mt-6 max-w-3xl font-serif text-xl leading-relaxed text-[#d7cfc2] sm:text-2xl">
            {node.title || '旧图只登记了这一线索名称。'}
          </p>
          <div className="mt-8 max-w-3xl border-l-2 border-[#d8a45e] pl-5 text-sm leading-7 text-[#c9c5bd]">
