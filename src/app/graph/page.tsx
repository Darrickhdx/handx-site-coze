    ...
    <div className="graph-story-page overflow-hidden">
      ...
      <section className="border-b border-foreground/15">
        <div className="personal-shell grid gap-10 py-14 sm:py-20 lg:grid-cols-[minmax(0,0.85fr)_minmax(28rem,1.15fr)] lg:items-end lg:gap-20">
          <div>
            ...
            <h1 className="personal-display mt-7 text-[clamp(3.4rem,6.5vw,6.4rem)] font-semibold leading-[0.94] tracking-[-0.06em]">
              人物与历史，
              <br />
              如何连成证据
            </h1>
      ...
      {viewMode === 'atlas' ? (
          ...
          <div className="grid gap-px overflow-hidden border border-foreground/15 bg-foreground/15 lg:grid-cols-3">
            {graphStoryRoutes.map((routeItem) => (
              ...
              >
                ...
                <span className="mt-3 block text-sm leading-7 text-foreground">{routeItem.path}</span>
        ...
        <div className="personal-shell">
            ...
            >
              {activeRoute && (
                <div className="border-b border-foreground/15 pb-6">
                  ...
                  <p className="mt-3 text-sm leading-7 text-muted-foreground">{activeRoute.note}</p>
                </div>
              )}
              ...
              {activeStep && (
                <div className="border-b border-foreground/15 py-6">
                  ...
                  <p className="mt-3 text-sm leading-7">{activeStep.moment}</p>
                  <p className="mt-4 border-l-2 border-primary pl-3 font-serif text-base leading-7 text-muted-foreground">
                    {activeStep.quote}
                  </p>
              ...
              {rawNode ? (
                <div className={cn((activeRoute || activeStep) && 'pt-6')}>
                  ...
                  <p className="mt-6 border-l-2 border-primary pl-4 text-sm leading-7 text-foreground">
          ...
          <section className="border-y border-white/15 bg-[#202827] py-16 text-[#f3efe7] sm:py-20">
        <div className="personal-shell grid gap-10 lg:grid-cols-[0.7fr_1.3fr] lg:gap-20">
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            <p className="border-t border-white/20 pt-5 text-sm leading-7 text-[#c9c5bd]">
